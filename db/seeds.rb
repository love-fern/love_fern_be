...
business.ferns.create!(name: 'Drew', preferred_contact_method: 'phone', health: 0)
...
brady.interactions.create!(evaluation: -0.5, description: 'message')
brady.interactions.create!(evaluation: -0.3, description: 'message')
brady.interactions.create!(evaluation: -0.8, description: 'message')
brady.interactions.create!(evaluation: 0.3, description: 'message')
brady.interactions.create!(evaluation: 0.4, description: 'message')
brady.interactions.create!(evaluation: -0.8, description: 'message')